package com.nixstack.component.search.service;
...
public class SearchService {
    @Value("${boundless.course.index}")
    private String index;
    @Value("${boundless.course.type}")
    private String type;
    @Value("${boundless.course.source_field}")
    ...
    public PageResultRes<CoursePub> list(int page, int size, CourseSearchParam courseSearchParam) {
        ...
        PageResult<CoursePub> queryResult = new PageResult();
        ...
        return new PageResultRes<CoursePub>(ECommonCode.SUCCESS, queryResult);
    }
}
